...
export interface TicTacToeMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createGame"
      | "gameCounter"
...
export interface TicTacToeMock extends BaseContract {
  connect(runner?: ContractRunner | null): TicTacToeMock;
  waitForDeployment(): Promise<this>;

  interface: TicTacToeMockInterface;
  ...
  filters: {
    ...
    "MoveMade(uint256,address,uint8,uint8)": TypedContractEvent<
      MoveMadeEvent.InputTuple,
      MoveMadeEvent.OutputTuple,
      MoveMadeEvent.OutputObject
    >;
